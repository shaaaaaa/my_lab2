...
//    return;
    ...
    index_t *print_graph=new index_t[vert_count+1];
    index_t size_1_count=0;
    index_t size_2_count=0;
    index_t size_3_count=0;
    index_t other_count=0;
...
//    index_t *color_times = new index_t[vert_count + 1];
    ...
    index_t *choose=new index_t[vert_count+1];
