...
//        {
            ...
            if(out_degree == 1)
            {
                ...
                if(neighbor_out_degree == 1 && neighbor_out_neighbor == vert_id)
                {
                    if(size_2_count<exp_size_2){
                        size_2_count +=2;
                        print_graph[vert_id] = 1;
                        print_graph[out_neighbor] = 1;
                    }
                    scc_id[vert_id] = -2;
                    scc_id[out_neighbor] = -2;
                    continue;
        ...
        if(scc_id[vert_id] == 0)
        {
            ...
            if(out_degree == 1)
            {
                ...
                if(B_out_degree == 1)
                {
                    ...
                    if(C_out_degree == 1 && C_out_neighbor == vert_id)
                    {
                        if(size_3_count<exp_size_3){
                            size_3_count +=3;
                            print_graph[vert_id] = 1;
                            print_graph[out_neighbor] = 1;
                            print_graph[B_out_neighbor] = 1;
                        }
                        scc_id[vert_id] = -3;
                        scc_id[out_neighbor] = -3;
                        scc_id[B_out_neighbor] = -3;
                ...
                if(B_out_degree == 1 && B_out_neighbor == vert_id)
                {
                    ...
                    if(C_out_degree == 1 && C_out_neighbor == vert_id)
                    {
                        if(size_3_count<exp_size_3){
                            size_3_count +=3;
                            print_graph[vert_id] = 1;
                            print_graph[out_neighbor_B] = 1;
                            print_graph[out_neighbor_C] = 1;
                        }
                        scc_id[vert_id] = -4;
                        scc_id[out_neighbor_B] = -4;
                        scc_id[out_neighbor_C] = -4;
                ...
                if(B_in_degree == 1 && B_in_neighbor == vert_id)
                {
                    ...
                    if(C_in_degree == 1 && C_in_neighbor == vert_id)
                    {
                        if(size_3_count<exp_size_3){
                            size_3_count +=3;
                            print_graph[vert_id] = 1;
                            print_graph[in_neighbor_B] = 1;
                            print_graph[in_neighbor_C] = 1;
                        }
                        scc_id[vert_id] = -4;
                        scc_id[in_neighbor_B] = -4;
                        scc_id[in_neighbor_C] = -4;
